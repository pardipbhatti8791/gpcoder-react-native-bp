            ...
            <ScrollView>
                <MainFrame>
                    ...
                    <View>
                        ...
                        <TimerView style={{marginTop: 16, alignItems: 'center'}}>
                            <View style={{alignItems: 'center'}}>
                                <Text style={{color: '#FFFFFF', fontSize: 16, alignItems: 'center'}}>
                                    Starts At
                                </Text>
                            ...
                            <View style={{alignItems: 'center'}}>
                                <Text style={{color: '#FFFFFF', fontSize: 16}}>Ends At</Text>
                                <TouchableOpacity
                                    onPress={() => {
                                        {
                                            setVisibleTimer(true),
